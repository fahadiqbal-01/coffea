    ...
    <main className="bg-primary min-h-screen">
      ...
      <section className="bg-void pt-40 pb-24">
        <Container className="text-center">
          <h1 className="font-zodiak text-white text-[42px] md:text-[64px]">Our Story</h1>
        </Container>
      </section>
      ...
      <section className="py-24">
        <Container className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="font-zodiak text-void text-[32px] md:text-[42px] leading-tight mb-6">
      ...
      <section className="bg-primary py-24 border-y border-void/10">
        <Container>
          <h2 className="font-zodiak text-void text-[32px] md:text-[42px] text-center mb-16">The Journey of a Bean</h2>
